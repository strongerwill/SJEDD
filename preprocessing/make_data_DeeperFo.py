...
'''
only need to process the manipulated videos, because the real videos are directly borrowed from FF++ c23...
'''
...
if __name__ == '__main__':
    ...
    p.add_argument('--video_path', type=str, default="/data0/mian2/DeeperForensics/videos/")
    p.add_argument('--save_path', type=str, default='/data0/mian2/DeeperForensics/faces/')
    args = p.parse_args()

    print('processing the end_to_end videos......')
    video_path = join(args.video_path, 'end_to_end')
    save_path = join(args.save_path, 'end_to_end')
    extract_method_videos(video_path, save_path)

    # print('processing the end_to_end_level_1 videos......')
    # video_path = join(args.video_path, 'end_to_end_level_1')
    # save_path = join(args.save_path, 'end_to_end_level_1')
    # extract_method_videos(video_path, save_path)
